...
const ServiceCard = ({ card }: ServiceCardComponentProps) => {
  ...
  return (
    <div
      className={`relative flex flex-col border border-text items-center justify-start gap-2 md:gap-4 h-[280px] w-[136px] md:h-[420px] md:w-[270px] px-4 text-center card-shadow py-2
      ${
        card.loc == "r"
