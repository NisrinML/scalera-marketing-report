    ...
    return (
        <div className={`flex ${card.loc == 'r' ? `flex-row` : `flex-row-reverse`} w-full`}>
            <div className="flex flex-col flex-1 ">
                <div className="flex flex-col items-start text-right justify-between gap-4 py-8 px-4 md:gap-8 md:py-32 md:px-8">
                    <h1 className="subtitle text-subtitle">{card.title}</h1>
                    <p className="text text-text">{card.desc}</p>
                    <NavLink to="" className="text text-link ">ابدأ التقييم المجاني</NavLink>
                </div>
            </div>
