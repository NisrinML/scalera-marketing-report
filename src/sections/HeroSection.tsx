...
const HeroSection = () => {
  ...
  return (
    <section className="relative md:py-20 lg:py-0 lg:h-screen max-h-[900px] pt-20 lg:pt-0 overflow-hidden mx-auto px-8 lg:px-0  flex flex-col md:flex-row gap-4 items-center">
