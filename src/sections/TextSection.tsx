...
const TextSection = () => {
  return (
        <section className=" mx-auto px-8 lg:px-0 flex items-center justify-center py-6 md:py-12">
            <div className='flex flex-col gap-2 lg:gap-4 text-center px-10 py-6 lg:px-44 lg:py-12 border border-text rounded-tl-[50px] rounded-br-[50px] lg:rounded-tl-[100px] lg:rounded-br-[100px]'>
      <h1 className="main-title text-linear">النجاح استراتيجية لا صدفة</h1>
